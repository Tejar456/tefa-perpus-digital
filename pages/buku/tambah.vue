  ...
  <div>
    <div class="container">
      ...
      <form @submit.prevent="tambahBuku">
        ...
        <div class="mb-3">
          <select v-model="form.kategori" class="form-control form-control-lg form-select radius">
        ...
        <div class="mb-3">
          <select v-model="form.rak" class="form-control form-control-lg form-select radius">
